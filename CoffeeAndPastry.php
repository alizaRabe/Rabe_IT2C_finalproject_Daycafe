...
<html>
   ...
   <body>
      <?php
      $xml = simplexml_load_file('Rabe_IT2C_DAYCAFE/CoffeeAndPastry.xml');
      ?>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            ...
            <div class="about_section_2 layout_padding">
               <div class="image_iman"><?php echo'<img src="images/coffee and pastry.jpg" class="about_img"alt="#"/>' ?></div>
