...
<html>
   ...
   <body>
      <?php
      $xml = simplexml_load_file('Rabe_IT2C_DAYCAFE/BeanVarieties.xml');
      ?>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            ...
            <div class="about_section_2 layout_padding">
               <div class="image_iman"><?php echo'<img src="images/coffee bean variety.jpg" class="about_img"alt="#"/>' ?></div>
