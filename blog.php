...
<html>
   ...
   <body>
      <?php
      $xml = simplexml_load_file('Rabe_IT2C_DAYCAFE/blog.xml');
      ?>
      ...
      <div class="blog_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h1 class="about_taital"><?php echo $xml ->content->ourblog;?></h1>
            ...
            <div class="blog_section_2">
               <div class="row">
                  <div class="col-md-6">
                     <div class="blog_box">
                        <div class="blog_img"><?php echo'<img src="images/BGC Branch.jpg"alt="#"/>' ?></div>
                        <h4 class="date_text"><?php echo $xml ->content->date;?></h4>
                        <h4 class="prep_text"><?php echo $xml ->content->techniques;?></h4>
                     </div>
                     <div class="read_bt"><a href="#"><?php echo $xml ->content->read;?></a></div>
                  </div>
                  <div class="col-md-6">
                     <div class="blog_box">
                        <div class="blog_img"><?php echo'<img src="images/Quezon City Branch.jpg"alt="#"/>' ?></div>
                        <h4 class="date_text"><?php echo $xml ->content->date;?></h4>
                        <h4 class="prep_text"><?php echo $xml ->content->techniques;?></h4>
                     </div>
                     <div class="read_bt"><a href="#"><?php echo $xml ->content->read;?></a></div>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group">
                     ...
                     <div class="subscribe_bt"><a href="#"><?php echo'<img src="images/teligram-icon.png"alt="#"/>' ?></a></div>
                  </div>
               </div>
            </div>
         </div>
