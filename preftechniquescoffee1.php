...
<html>
   <head>
      ...
      <!-- site metas -->
      <title>Pref Techniques Coffee 1</title>
   ...
   <body>
      <?php
      $xml = simplexml_load_file('Rabe_IT2C_DAYCAFE/preftechniquescoffee1.xml');
      ?>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            ...
            <div class="about_section_2 layout_padding">
               <div class="image_iman"><?php echo'<img src="images/cafe2.jpg" class="about_img" alt="#"/>' ?></div>
